...
<div class="live_rep_content">   
	<div id="hdr">    
			...
			<div class="survey_details_header">				 
					 Survey Round:&nbsp;&nbsp; MPH Regular Evalutation<br>
					 Survey Start:<?php 
			...
			<div class="hdr_bolden">&nbsp;&nbsp;&nbsp;&nbsp;Survey Summary</div>
			 <div class="tbl"> 
				 <table>
					...
					<td width="38">
					<?php
					 $sptcheck_total  = pg_fetch_result($obj->calculateDashboardMetrics('mph','total'),0);
...
<div id="bdr">
   <div class="tbl">   
       <table id ="mph_report">
		 ...
		 // print each row
		  $result = $obj->getDashboardVars('mph','spotcheck');
		 while ($row = pg_fetch_array($result)) {
			   ...
			   <tr>
	            ...
	            ?>
				  ...
				  <div class="numalign">
				  <?php
				  	$rst = $obj->calculateDashboardMetrics('mph',$row['id']);
