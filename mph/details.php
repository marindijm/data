...
<div class="live_rep_detail_content">  
	<div id="hdr">    
			...
			<div class="survey_details_header">				 
					 ...
					 $result = $obj->calculateDashboardMetrics('mph','survey_start');
					 ...
					 $result = $obj->calculateDashboardMetrics('mph','survey_stop');
			...
			<div class="tbl"> 
				 <table>
					...
					&nbsp;Metric:
					 ...
					 if($id == '17')
					 {
					    $mt =  pg_fetch_result($obj->getMetricDetails('mph','2'),0)." - ".pg_fetch_result($obj->getMetricDetails('mph',$id),0);					
					    echo  $mt;
					 
					 }
					 elseif($id == '27')
					 {
					     $mt =  pg_fetch_result($obj->getMetricDetails('mph','21'),0)." - ".pg_fetch_result($obj->getMetricDetails('mph',$id),0);					
					    echo  $mt;
					 }
					 elseif($id == '29' or $id == '30')
					 {
					     $mt =  pg_fetch_result($obj->getMetricDetails('mph','28'),0)." - ".pg_fetch_result($obj->getMetricDetails('mph',$id),0);					
					     echo  $mt;
					 }
					  elseif($id == '32' or $id == '33')
					 {
					     $mt =  pg_fetch_result($obj->getMetricDetails('mph','31'),0)." - ".pg_fetch_result($obj->getMetricDetails('mph',$id),0);					
					     echo  $mt;
					 }
					  elseif($id == '35' or $id == '36')
					 {
					     $mt =  pg_fetch_result($obj->getMetricDetails('mph','34'),0)." - ".pg_fetch_result($obj->getMetricDetails('mph',$id),0);					
					     echo  $mt;
					 }
					 else
					 {
					    $mt = pg_fetch_result($obj->getMetricDetails('mph',$id),0);					
					 echo  $mt;
					 }
					 ?>					
					 </div>
					...
					&nbsp;Respondents No:
					<?php
					 $res_num = pg_fetch_result($obj->calculateDashboardMetrics('mph',$id),0);					
					 echo  $res_num;
					?>					
					</div>
					</td>
   ...
   <div class="tbl">   
       <table id ="report" >
		...
		<tr>
				 ...
				 // print each row
				  $result = $obj->getSurveyDetails('mph',$id,'waterpoint_id','r106');
