...
class Issuetype extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('issuetypename', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('issuetypeid, issuetypename', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'issues' => array(self::HAS_MANY, 'Issue', 'issuetypeid'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('issuetypename',$this->issuetypename,true);
