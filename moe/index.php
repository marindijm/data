			...
			<div class="hdr_bolden">&nbsp;&nbsp;&nbsp;&nbsp;Survey Summary</div>
			 <div class="tbl"> 
				 <table>
					...
					<td width="38">
					<?php
					 $sptcheck_total  = pg_fetch_result($obj->calculateDashboardMetrics('moe','total'),0);
...
<div id="bdr">
   <div class="tbl">   
       <table id ="moe_report">
		 ...
		 // print each row
		  $result = $obj->getDashboardVars('moe','spotcheck');
		 while ($row = pg_fetch_array($result)) {
			   ...
			   <tr>
	            ...
	            ?>
				  ...
				  <div class="numalign">
				  <?php
				  	$rst = $obj->calculateDashboardMetrics('moe',$row['id']);
